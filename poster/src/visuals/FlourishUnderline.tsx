 ...
 * the single-loop canonical variant (lx=127, zero jitter) the video uses
 * under the HookSlide "training models" phrase. Drawn without animation so
 * it appears fully-formed on paper.
 */
